...
<html>
    <head>
        ...
        <!-- jvector{{asset('css/jvectormap/jquery-jvectormap-1.2.2.css')}}" rel="stylesheet" type="text/css" />
        <!-- fullCalendar -->
    ...
    <body class="skin-black">
        ...
        <header class="header">
            <a href="instrDashboard.html" class="logo">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="">
                            <a href="addCourse.html">
                                <i class="fa fa-table"></i> <span>Add Course</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="courses.html">
