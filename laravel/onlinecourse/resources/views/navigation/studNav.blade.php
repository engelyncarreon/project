...
<html>
    ...
    <body class="skin-black">
        ...
        <header class="header">
            <a href="studDashboard.html" class="logo">
                    ...
                    <ul class="sidebar-menu">
                        <li class="active">
                            <a href="studDashboard.html">
                                <i class="fa fa-edit"></i> <span>Current Course</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="finishedCourse.html">
                                <i class="fa fa-edit"></i> <span>Finished Course</span>
                            </a>
                        </li>
                        <li>
