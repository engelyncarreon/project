            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="panel panel-student">
                        ...
                        <a href = "LessonArea.php?c=<?php echo $rowongoing['course_id'];?>&d=<?php echo $rowongoing['current_lesson'];?>&m=<?php echo $rowongoing['lecture_id'];?>&l=<?php echo $rowongoing['lesson_id'];?>">
