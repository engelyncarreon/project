                ...
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <a href="enroll.php"><i class="fa fa-tasks"></i> Enroll</a>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header"><i class = 'fa fa-tasks'></i> Enroll</h1>
                        ...
                        <ol class = "breadcrumb">
                         ...
                         <?php
                            ...
                            while($qur =  mysqli_fetch_assoc($qu)){
                                ...
                                echo "<br>  <form action = 'paidornot.php' method = 'POST'>
                                        <tr>
