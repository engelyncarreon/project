            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                       ...
                       <?php 
                            $po = $_POST['spec'];
                            $stud = "Select * from student where student_id = '$po'";
                            $sto = mysqli_query($con,$stud);
                            $str = mysqli_fetch_assoc($sto);
                            
                        ?>
                        <p>Name: <?php echo $str['stud_firstName']. " ". $str['stud_lastName']; ?></p>
                        <p>Age: <?php echo $str['stud_age']; ?></p>
                        <p>Age: <?php echo $str['stud_age']; ?></p>
