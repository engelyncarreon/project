                                ...
                                <?php
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-items">
                                            ...
                                            <a href="LessonArea.php?c=<?php echo $cid; ?>&d=<?php echo $studrow['lesson_seq'];?>&m=<?php echo $less3row['lecture_id'];?>&l=<?php echo $studrow['lesson_id'];?>">
