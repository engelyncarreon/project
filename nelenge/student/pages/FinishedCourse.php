            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="panel panel-student">
                        ...
                        <a href = "LessonArea.php?c=<?php echo $rowfinished['course_id'];?>&d=<?php echo $rowfinished['current_lesson'];?>&m=<?php echo $rowfinished['lecture_seq'];?>&l=<?php echo $rowfinished['lesson_id'];?>">
