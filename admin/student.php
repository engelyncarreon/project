                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <?php
                            ...
                            $query = "SELECT * FROM registration where typeOfuser = 'Student' and user_status in ('Pending','Declined') limit $startfrom, $pageshow";
                                ...
                                while ($row = $result -> fetch_assoc()){
                                    ...
                                    echo "<form action = 'acceptDeclineStud.php'>
                                            <tr>
                                                ...
                                                <td class = 'text-center'>" . "<input type = 'hidden' name = 'user_username' value = '". $row["user_username"]."'/>" . "<button class = 'ok' type = 'submit' name = 'user_status' value = 'Accepted'></button>" . "<button class = 'no'  = 'submit' name = 'user_status' value='Declined'></button>" . "</td>
                                            </tr>
                                            </form>";
                                }
                            ...
                            <?php 
                                ...
                                $sqlquery = "Select count(registration_id) as total from registration where typeOfuser = 'Student'";
                                ...
                                for ($i=1; $i<=$total_pages;$i++){
                                    ...
                                    <a class = 'active' href = 'student.php?page=".$i."'";
