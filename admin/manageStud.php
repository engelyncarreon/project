            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header"><i class = "fa fa-user"></i> Student</h1>
                        ...
                        <?php
                            ...
                            $query = "SELECT * FROM student where stud_status in ('Activate', 'Deactivate') limit $startfrom, $pageshow";
                            ...
                            if ($result ->num_rows > 0){
                                ...
                                while ($row = $result -> fetch_assoc()){
                                    ...
                                    echo "<form action = 'activateDeactivateStud.php'>
                                            <tr>
                                                <td class = 'text-center'>" . $row["stud_lastName"] . "</td>
                                                <td class = 'text-center'>" . $row["stud_firstName"] . "</td>
                                                <td class = 'text-center'>" . $row["stud_username"] . "</td>
                                                <td class = 'text-center'>" . $row["stud_email"] . "</td>
                                                <td class = 'text-center'>" . $row["stud_address"] . "</td>
                                                <td class = 'text-center'>" . $row["stud_contactno"] . "</td>
                                                <td class = 'text-center'>" . $row["stud_gender"] . "</td>
                                                <td class = 'text-center'>" . $row["stud_age"] ."</td>
                                                <td class = 'text-center'>" . $row["stud_status"] ."</td>
                                                <td class = 'text-center'>" . "<input type = 'hidden' name = 'stud_username' value = '". $row["stud_username"]."'/>" . "<button class = 'ok' type = 'submit' name = 'stud_status' value = 'Activate'></button>" . "<button class = 'no' type = 'submit name = 'stud_status' value = 'Deactivate'></button>" . "</td>
                                            </tr>
                                            </form>";
                                }
                        ...
                        <?php 
                            ...
                            $sqlquery = "Select count(student_id) as total from student";
                            ...
                            for ($i=1; $i<=$total_pages;$i++){
                                ...
                                <a class = 'active' href = 'manageStud.php?page=".$i."'";
